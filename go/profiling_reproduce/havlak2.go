// a single-file version of Hindt's loop finding program
// source https://github.com/hundt98847/multi-language-bench
...
// ===
// original file: basicblock.go.
// 		This file contains methods to build and analyze control-flow-graph (CFG).
// ===
...
func (bb *BasicBlock) Dump() {
	...
	if len(bb.InEdges) > 0 { //-- opt: inline
		fmt.Printf("in : ")
		for _, iter := range bb.InEdges { //-- opt: avoid indirection
...
func (bb *BasicBlock) NumPred() int {
	return len(bb.InEdges) //-- opt: use len(v) instead of v.Len (?)
}
...
// ===
// end of original file basicblock.go
// ===

// ===
// original file lsg.go.
// 		This file contains datastruct to represent loops
//
...
// ===
// end of original file lsg.go
// ===

// ===
// original file havlakloopfinder.go
// 		This file contains code to detect loops.
// ===
...
// added helper for performance
// append x to a if x is not already in a
...
// ===
// end of original file havlakloopfinder.go
// ===

// ===
// original file: looptesterapp.go.
